...
async def notifications_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """
    Команда /notifications - показывает настройки уведомлений пользователя
    """
    ...
    all_disabled = not updates_enabled and not changes_enabled and not promo_enabled
...
async def handle_notifications_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """
    Обрабатывает callback-запросы для настроек уведомлений
    """
    ...
    if data in ['toggle_updates', 'toggle_changes', 'toggle_promo', 'toggle_all']:
